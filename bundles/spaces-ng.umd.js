(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('ngx-bowser'), require('@angular/http'), require('rxjs/add/operator/map'), require('@angular/common/http'), require('@angular/router')) :
	typeof define === 'function' && define.amd ? define('spaces-ng', ['exports', '@angular/core', 'ngx-bowser', '@angular/http', 'rxjs/add/operator/map', '@angular/common/http', '@angular/router'], factory) :
	(factory((global['spaces-ng'] = {}),global.ng.core,global.ngxBowser,global.ng.http,global.Rx.Observable.prototype,global.ng.common.http,global.ng.router));
}(this, (function (exports,core,ngxBowser,http,map,http$1,router) { 'use strict';
...
var SpacesBaseService = (function () {
    function SpacesBaseService(http$$1, logging) {
        var _this = this;
        this.http = http$$1;
    ...
    SpacesBaseService.prototype.tcTokenRenew = function () {
        var _this = this;
        var params = new http.URLSearchParams('', new SpacesQueryEncoder());
...
var SpacesRequestService = (function () {
    function SpacesRequestService(http$$1, logging, spacesBase) {
        this.http = http$$1;
        this.logging = logging;
        this.spacesBase = spacesBase;
        this.headers = new http.Headers();
        this.params = new http.URLSearchParams('', new SpacesQueryEncoder$1(this.logging));
        this.options = new http.RequestOptions({
    ...
    SpacesRequestService.prototype.proxyUrl = function () {
        var params = new http.URLSearchParams();
...
var SpacesLandingPageComponent = (function () {
    function SpacesLandingPageComponent(http$$1, spacesBaseService, router$$1) {
        this.http = http$$1;
...
exports.SpacesBaseService = SpacesBaseService;
exports.SpacesLoggingService = SpacesLoggingService;
exports.SpacesMessagesService = SpacesMessagesService;
exports.SpacesParamsResolve = SpacesParamsResolve;
exports.SpacesRequestService = SpacesRequestService;
exports.SpacesStorageService = SpacesStorageService;
exports.SpacesUtilityService = SpacesUtilityService;
exports.SpacesModule = SpacesModule;
exports.ɵa = SpacesLandingPageComponent;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=spaces-ng.umd.js.map
